  ...
  return (
   <footer className='border-t py-12 border-gray-200'>
     <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <form className="flex">
                ...
                <button type='submit' className='bg-black cursor-pointer text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all'>
                Subscribe
            </button>
            </form>
     ...
     <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
       <p className='text-gray-500 text-sm tracking-tighter text-center'>© 2025, Clotira. All Rights Reserved.</p>
     </div>
   </footer>
  )
}
