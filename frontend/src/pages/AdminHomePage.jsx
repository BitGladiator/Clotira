...
const AdminHomePage = () => {
  ...
  useEffect(() => {
    console.log("Dispatching admin fetches...");
    dispatch(fetchAdminProducts()).then((res) => console.log("Products:", res));
    dispatch(fetchAllOrders()).then((res) => console.log("Orders:", res));
  }, [dispatch]);
